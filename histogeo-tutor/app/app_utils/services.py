...
MEMORY_BANK_ID = "7823257778335514624"
...
def get_memory_service():
    """Process-wide memory service pointing to Vertex AI Memory Bank instance."""
    ...
    mb_id = os.environ.get("MEMORY_BANK_ID", MEMORY_BANK_ID)
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-d87f671eabf0")
    location = os.environ.get("MEMORY_BANK_LOCATION", MEMORY_BANK_LOCATION)
